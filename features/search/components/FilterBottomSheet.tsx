  ...
  return (
    <Modal visible={visible} animationType="slide" transparent>
      ...
      >
        {/* Header */}
        <View
          className={isRTL ? "flex-row-reverse items-center justify-between px-4 py-3 border-b" : "flex-row items-center justify-between px-4 py-3 border-b"}
        ...
        <ScrollView className="flex-1 px-4 py-4">
          ...
          <View className="mb-6">
            ...
            {subCategories.length > 0 && (
              <View className={isRTL ? "mr-3 mt-2" : "ml-3 mt-2"}>
                <Text
                  className="text-xs font-semibold mb-2"
                  style={{ color: tokens.mutedForeground }}
                >
                  {t("search.filters.subCategories")}
                </Text>
                <FlatList
                  scrollEnabled={false}
                  data={subCategories}
          ...
          <View className="mb-6">
            ...
            <View className="flex-row justify-between mb-2">
              <Text style={{ color: tokens.mutedForeground }}>
                {priceMin.toFixed(2)} {t("common.egp")}
              </Text>
              <Text style={{ color: tokens.mutedForeground }}>
                {priceMax.toFixed(2)} {t("common.egp")}
              </Text>
            </View>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <Pressable
                  ...
                  className={isRTL ? "flex-row-reverse items-center py-2 px-3 rounded mb-2" : "flex-row items-center py-2 px-3 rounded mb-2"}
                  style={{
                ...
                >
                  <View
                    className={isRTL ? "w-5 h-5 rounded border-2 ml-2" : "w-5 h-5 rounded border-2 mr-2"}
                    style={{
          ...
          >
            <Text style={{ color: tokens.foreground }}>{t("search.filters.inStockOnly")}</Text>
            <Switch
              value={inStockOnly}
